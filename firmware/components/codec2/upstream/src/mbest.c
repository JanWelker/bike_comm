...
/* bike_comm vendored: routed through the project's MALLOC macro so
 * mbest state lands in the SPIRAM-backed codec2_malloc pool instead
 * of starving internal DRAM. */
