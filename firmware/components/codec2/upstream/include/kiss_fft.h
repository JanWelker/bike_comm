...
#else
/* bike_comm vendored: route through codec2_malloc/free so the project's
 * SPIRAM-backed allocator catches kiss_fft's state too. The upstream
 * default was bare libc malloc/free. */
